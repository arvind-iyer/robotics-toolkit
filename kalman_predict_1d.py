# Implementing a multi-dimensional Kalman filter with tracking and prediction


from math import *

## Matrix class to simplify matrix operations
class matrix:
...
# Implementing the filter function below
